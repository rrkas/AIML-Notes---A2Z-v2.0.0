...
\begin{itemize}
    \item \textit{Words that occur in similar contexts tend to have similar meanings.}\\ This link between similarity in how words are distributed and similarity in what they mean is called the \textbf{distributional hypothesis} \index{distributional hypothesis} \label{distributional hypothesis}.
...
\begin{itemize}
    \item when one word has a sense whose meaning is identical to a sense of another word, or nearly identical, we say the two senses of those two words are \textbf{synonyms} \index{synonyms} \label{synonyms}.
    ...
    \item One of the fundamental tenets of semantics, called the \textbf{principle of contrast} \index{principle of contrast}\label{principle of contrast}, states that a difference in linguistic form is always associated with some difference in meaning.
\end{itemize}
...
\begin{itemize}
    ...
    \item One common kind of relatedness between words is if they belong to the same \textbf{semantic field} \index{semantic field}\label{semantic field}. A semantic field is a set of words which cover a particular semantic domain and bear structured relations with each other.\\
...
\begin{itemize}
    ...
    \item Positive or negative evaluation language is called \textbf{sentiment}\index{sentiment}\label{sentiment}.\\
...
\begin{itemize}
    ...
    \item Vectors for representing words are called \textbf{embeddings}\index{word embeddings}\label{word embeddings}. The word “embedding” derives from its mathematical sense as a mapping from one space or structure to another.

\end{itemize}

SEE: \nameref{Term Frequancy-Inverse Document Frequency (TF-IDF)}
