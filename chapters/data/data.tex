...
\begin{enumerate}
    ...
    \begin{enumerate}
        \item Ignoring them
        \item Removing them
        \item Substitute them, using statistical methods, with a more plausible alternative (imputation\index{imputation})
    \end{enumerate}
\end{enumerate}
...
\subsection{Interquartile Range (IQR) \cite{ism-1}}\label{iqr}
